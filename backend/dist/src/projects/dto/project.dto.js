...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'University project for PRM393 course.' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Smart Task v2' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.MaxLength)(100),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'member@gmail.com', description: 'User email to add as project member' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
